...
Example
  -  Suppose the unique identification of a household is a combination of
     ...
     if option 3 is chosen, it is crucial to preserve (but not distribute)
...
Example
 - *Table 15* shows two versions of one dataset that provides 
   ...
   uncompressed and version 2 compressed. In the uncompressed version, 
   ...
   the total savings would be 3,500 bytes per observation; if this data set
